...
class ScryptoSchema(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sbor_data, *args, **kwargs):  # noqa: E501
        """ScryptoSchema - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, sbor_data, *args, **kwargs):  # noqa: E501
        """ScryptoSchema - a model defined in OpenAPI
