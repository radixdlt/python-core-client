...
class StateResourceRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network, resource_address, *args, **kwargs):  # noqa: E501
        """StateResourceRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network, resource_address, *args, **kwargs):  # noqa: E501
        """StateResourceRequest - a model defined in OpenAPI
