...
class ExecutedScenarioTransaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, logical_name, state_version, intent_hash, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, logical_name, state_version, intent_hash, *args, **kwargs):  # noqa: E501
        """ExecutedScenarioTransaction - a model defined in OpenAPI
