...
class StateValidatorRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network, validator_address, *args, **kwargs):  # noqa: E501
        """StateValidatorRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network, validator_address, *args, **kwargs):  # noqa: E501
        """StateValidatorRequest - a model defined in OpenAPI
