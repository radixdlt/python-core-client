...
class TransactionMessage(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'EncryptedTransactionMessage': EncryptedTransactionMessage,
            'Plaintext': PlaintextTransactionMessage,
            'PlaintextTransactionMessage': PlaintextTransactionMessage,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """TransactionMessage - a model defined in OpenAPI
