...
class ConsensusManagerFieldCurrentProposalStatisticValue(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, completed, missed, *args, **kwargs):  # noqa: E501
        """ConsensusManagerFieldCurrentProposalStatisticValue - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, completed, missed, *args, **kwargs):  # noqa: E501
        """ConsensusManagerFieldCurrentProposalStatisticValue - a model defined in OpenAPI
