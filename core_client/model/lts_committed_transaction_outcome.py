...
class LtsCommittedTransactionOutcome(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state_version, accumulator_hash, status, fungible_entity_balance_changes, resultant_account_fungible_balances, total_fee, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            fungible_entity_balance_changes ([LtsEntityFungibleBalanceChanges]): THE FEE ASSIGNMENT IS NOT CURRENTLY FULLY ACCURATE FOR SOME TRANSACTIONS. THIS WILL BE FIXED AT RCNET-V2. A list of all fungible balance updates which occurred in this transaction, aggregated by the global entity (such as account) which owns the vaults which were updated. 
            resultant_account_fungible_balances ([LtsResultantAccountFungibleBalances]): THIS CURRENTLY RETURNS AN EMPTY LIST. THIS FEATURE WILL BE COMING AT RCNET-V2. A list of the resultant balances of any account balances changed in this transaction. Only balances for accounts are returned, not any other kind of entity. 
        ...
        Keyword Args:
            ...
            user_transaction_identifiers (TransactionIdentifiers): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, state_version, accumulator_hash, status, fungible_entity_balance_changes, resultant_account_fungible_balances, total_fee, *args, **kwargs):  # noqa: E501
        """LtsCommittedTransactionOutcome - a model defined in OpenAPI
