...
def lazy_import():
    ...
    globals()['CountOfProofRuleAllOf'] = CountOfProofRuleAllOf
...
class CountOfProofRule(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'list': ([Requirement],),  # noqa: E501
            'type': (ProofRuleType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'AllOf': AllOfProofRule,
            'AmountOf': AmountOfProofRule,
            'AnyOf': AnyOfProofRule,
            'CountOf': CountOfProofRule,
            'Require': RequireProofRule,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, count, list, type, *args, **kwargs):  # noqa: E501
        """CountOfProofRule - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, count, list, type, *args, **kwargs):  # noqa: E501
        """CountOfProofRule - a model defined in OpenAPI
