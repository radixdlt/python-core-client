...
class InvalidDataObjectError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, invalid_data_object, message, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, invalid_data_object, message, type, *args, **kwargs):  # noqa: E501
        """InvalidDataObjectError - a model defined in OpenAPI
