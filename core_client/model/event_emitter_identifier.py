...
class EventEmitterIdentifier(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'FunctionEventEmitterIdentifier': FunctionEventEmitterIdentifier,
            'Method': MethodEventEmitterIdentifier,
            'MethodEventEmitterIdentifier': MethodEventEmitterIdentifier,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """EventEmitterIdentifier - a model defined in OpenAPI
