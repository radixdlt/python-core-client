...
def lazy_import():
    ...
    globals()['NodeIdentifiers'] = NodeIdentifiers


class NodeIdentifiersResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'node_identifiers': (NodeIdentifiers,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, node_identifiers, *args, **kwargs):  # noqa: E501
        """NodeIdentifiersResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, node_identifiers, *args, **kwargs):  # noqa: E501
        """NodeIdentifiersResponse - a model defined in OpenAPI
