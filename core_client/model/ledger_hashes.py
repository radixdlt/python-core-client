...
class LedgerHashes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state_tree_hash, transaction_tree_hash, receipt_tree_hash, *args, **kwargs):  # noqa: E501
        """LedgerHashes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, state_tree_hash, transaction_tree_hash, receipt_tree_hash, *args, **kwargs):  # noqa: E501
        """LedgerHashes - a model defined in OpenAPI
