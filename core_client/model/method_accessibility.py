...
class MethodAccessibility(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'OuterObjectOnlyMethodAccessibility': OuterObjectOnlyMethodAccessibility,
            'OwnPackageOnly': OwnPackageOnlyMethodAccessibility,
            'OwnPackageOnlyMethodAccessibility': OwnPackageOnlyMethodAccessibility,
            'Public': PublicMethodAccessibility,
            'PublicMethodAccessibility': PublicMethodAccessibility,
            'RoleProtected': RoleProtectedMethodAccessibility,
            'RoleProtectedMethodAccessibility': RoleProtectedMethodAccessibility,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """MethodAccessibility - a model defined in OpenAPI
