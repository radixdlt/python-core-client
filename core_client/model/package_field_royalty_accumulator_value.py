...
class PackageFieldRoyaltyAccumulatorValue(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vault_entity, *args, **kwargs):  # noqa: E501
        """PackageFieldRoyaltyAccumulatorValue - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, vault_entity, *args, **kwargs):  # noqa: E501
        """PackageFieldRoyaltyAccumulatorValue - a model defined in OpenAPI
