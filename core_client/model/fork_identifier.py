...
class ForkIdentifier(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, epoch, fork, *args, **kwargs):  # noqa: E501
        """ForkIdentifier - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, epoch, fork, *args, **kwargs):  # noqa: E501
        """ForkIdentifier - a model defined in OpenAPI
