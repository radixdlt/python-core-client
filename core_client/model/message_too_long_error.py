...
class MessageTooLongError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, maximum_message_length, attempted_message_length, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, maximum_message_length, attempted_message_length, type, *args, **kwargs):  # noqa: E501
        """MessageTooLongError - a model defined in OpenAPI
