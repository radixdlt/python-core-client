...
def lazy_import():
    ...
    globals()['PackageCodeVmTypeEntrySubstateAllOf'] = PackageCodeVmTypeEntrySubstateAllOf
...
class PackageCodeVmTypeEntrySubstate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'value': (PackageCodeVmTypeEntryValue,),  # noqa: E501
    ...
    def _from_openapi_data(cls, key, value, substate_type, is_locked, *args, **kwargs):  # noqa: E501
        """PackageCodeVmTypeEntrySubstate - a model defined in OpenAPI
