...
class KeyValueBasedStructure(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key_schema, value_schema, *args, **kwargs):  # noqa: E501
        """KeyValueBasedStructure - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key_schema, value_schema, *args, **kwargs):  # noqa: E501
        """KeyValueBasedStructure - a model defined in OpenAPI
