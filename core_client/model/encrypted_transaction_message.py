...
class EncryptedTransactionMessage(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'encrypted_hex': (str,),  # noqa: E501
            'curve_decryptor_sets': ([EncryptedMessageCurveDecryptorSet],),  # noqa: E501
            'type': (TransactionMessageType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'Encrypted': EncryptedTransactionMessage,
            'Plaintext': PlaintextTransactionMessage,
        }
        if not val:
            return None
        return {'type': val}
    ...
    attribute_map = {
        'encrypted_hex': 'encrypted_hex',  # noqa: E501
        'curve_decryptor_sets': 'curve_decryptor_sets',  # noqa: E501
        'type': 'type',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, encrypted_hex, curve_decryptor_sets, type, *args, **kwargs):  # noqa: E501
        """EncryptedTransactionMessage - a model defined in OpenAPI
        ...
        Args:
            ...
            curve_decryptor_sets ([EncryptedMessageCurveDecryptorSet]):
        ...
        self.encrypted_hex = encrypted_hex
        self.curve_decryptor_sets = curve_decryptor_sets
        self.type = type
    ...
    @convert_js_args_to_python_args
    def __init__(self, encrypted_hex, curve_decryptor_sets, type, *args, **kwargs):  # noqa: E501
        """EncryptedTransactionMessage - a model defined in OpenAPI
