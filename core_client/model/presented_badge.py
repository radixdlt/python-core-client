...
class PresentedBadge(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'NonFungiblePresentedBadge': NonFungiblePresentedBadge,
            'Resource': ResourcePresentedBadge,
            'ResourcePresentedBadge': ResourcePresentedBadge,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, resource_address, *args, **kwargs):  # noqa: E501
        """PresentedBadge - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, resource_address, *args, **kwargs):  # noqa: E501
        """PresentedBadge - a model defined in OpenAPI
