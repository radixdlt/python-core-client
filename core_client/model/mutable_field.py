...
class MutableField(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, index, *args, **kwargs):  # noqa: E501
        """MutableField - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, index, *args, **kwargs):  # noqa: E501
        """MutableField - a model defined in OpenAPI
