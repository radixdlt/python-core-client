...
class LtsTransactionSubmitErrorDetails(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'LtsTransactionSubmitIntentAlreadyCommitted': LtsTransactionSubmitIntentAlreadyCommitted,
            'LtsTransactionSubmitPriorityThresholdNotMetErrorDetails': LtsTransactionSubmitPriorityThresholdNotMetErrorDetails,
            'LtsTransactionSubmitRejectedErrorDetails': LtsTransactionSubmitRejectedErrorDetails,
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """LtsTransactionSubmitErrorDetails - a model defined in OpenAPI
