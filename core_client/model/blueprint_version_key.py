...
class BlueprintVersionKey(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blueprint_name, blueprint_version, *args, **kwargs):  # noqa: E501
        """BlueprintVersionKey - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blueprint_name, blueprint_version, *args, **kwargs):  # noqa: E501
        """BlueprintVersionKey - a model defined in OpenAPI
