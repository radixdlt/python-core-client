...
class SubstateIdAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, substate_type, substate_key, *args, **kwargs):  # noqa: E501
        """SubstateIdAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, substate_type, substate_key, *args, **kwargs):  # noqa: E501
        """SubstateIdAllOf - a model defined in OpenAPI
