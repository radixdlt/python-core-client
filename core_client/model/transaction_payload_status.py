...
class TransactionPayloadStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["CommittedSuccess", "CommittedFailure", "PermanentlyRejected", "TransientlyRejected", "InMempool", "NotInMempool", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["CommittedSuccess", "CommittedFailure", "PermanentlyRejected", "TransientlyRejected", "InMempool", "NotInMempool", ]  # noqa: E501
