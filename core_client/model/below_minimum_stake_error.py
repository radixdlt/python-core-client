...
class BelowMinimumStakeError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, minimum_stake, attempted_to_stake, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, minimum_stake, attempted_to_stake, type, *args, **kwargs):  # noqa: E501
        """BelowMinimumStakeError - a model defined in OpenAPI
