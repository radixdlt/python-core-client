...
class PlaintextMessageContent(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'BinaryPlaintextMessageContent': BinaryPlaintextMessageContent,
            'String': StringPlaintextMessageContent,
            'StringPlaintextMessageContent': StringPlaintextMessageContent,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """PlaintextMessageContent - a model defined in OpenAPI
