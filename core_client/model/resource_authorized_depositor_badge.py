...
class ResourceAuthorizedDepositorBadge(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (AuthorizedDepositorBadgeType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'NonFungible': NonFungibleAuthorizedDepositorBadge,
            'Resource': ResourceAuthorizedDepositorBadge,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_address, type, *args, **kwargs):  # noqa: E501
        """ResourceAuthorizedDepositorBadge - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_address, type, *args, **kwargs):  # noqa: E501
        """ResourceAuthorizedDepositorBadge - a model defined in OpenAPI
