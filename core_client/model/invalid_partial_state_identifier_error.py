...
class InvalidPartialStateIdentifierError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, invalid_partial_state_identifier, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, invalid_partial_state_identifier, type, *args, **kwargs):  # noqa: E501
        """InvalidPartialStateIdentifierError - a model defined in OpenAPI
