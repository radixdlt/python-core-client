...
class ErrorResponseType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["Basic", "TransactionSubmit", "LtsTransactionSubmit", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["Basic", "TransactionSubmit", "LtsTransactionSubmit", ]  # noqa: E501
