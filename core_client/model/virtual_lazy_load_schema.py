...
class VirtualLazyLoadSchema(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, export_name, *args, **kwargs):  # noqa: E501
        """VirtualLazyLoadSchema - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, export_name, *args, **kwargs):  # noqa: E501
        """VirtualLazyLoadSchema - a model defined in OpenAPI
