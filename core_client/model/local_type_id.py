...
class LocalTypeId(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, id, as_sbor, *args, **kwargs):  # noqa: E501
        """LocalTypeId - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, id, as_sbor, *args, **kwargs):  # noqa: E501
        """LocalTypeId - a model defined in OpenAPI
