...
class LocalTypeIndex(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, index, as_sbor, *args, **kwargs):  # noqa: E501
        """LocalTypeIndex - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, index, as_sbor, *args, **kwargs):  # noqa: E501
        """LocalTypeIndex - a model defined in OpenAPI
