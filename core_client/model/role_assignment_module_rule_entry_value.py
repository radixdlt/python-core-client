...
class RoleAssignmentModuleRuleEntryValue(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'access_rule': (AccessRule,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access_rule, *args, **kwargs):  # noqa: E501
        """RoleAssignmentModuleRuleEntryValue - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_rule, *args, **kwargs):  # noqa: E501
        """RoleAssignmentModuleRuleEntryValue - a model defined in OpenAPI
