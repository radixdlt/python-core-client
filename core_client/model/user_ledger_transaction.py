...
class UserLedgerTransaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, notarized_transaction, type, *args, **kwargs):  # noqa: E501
        """UserLedgerTransaction - a model defined in OpenAPI
        ...
        self.notarized_transaction = notarized_transaction
        self.type = type
    ...
    @convert_js_args_to_python_args
    def __init__(self, notarized_transaction, type, *args, **kwargs):  # noqa: E501
        """UserLedgerTransaction - a model defined in OpenAPI
