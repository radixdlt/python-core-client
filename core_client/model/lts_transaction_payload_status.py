...
class LtsTransactionPayloadStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """LtsTransactionPayloadStatus - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The status of the transaction payload, as per this node. A NotInMempool status means that it wasn't rejected at last execution attempt, but it's not currently in the mempool either. ., must be one of ["CommittedSuccess", "CommittedFailure", "PermanentlyRejected", "TransientlyRejected", "InMempool", "NotInMempool", ]  # noqa: E501
