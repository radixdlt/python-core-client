...
class EcdsaSecp256k1SignatureAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, signature_hex, *args, **kwargs):  # noqa: E501
        """EcdsaSecp256k1SignatureAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, signature_hex, *args, **kwargs):  # noqa: E501
        """EcdsaSecp256k1SignatureAllOf - a model defined in OpenAPI
