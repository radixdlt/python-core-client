...
class BinaryPlaintextMessageContent(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value_hex': (str,),  # noqa: E501
            'type': (PlaintextMessageContentType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'Binary': BinaryPlaintextMessageContent,
            'String': StringPlaintextMessageContent,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, value_hex, type, *args, **kwargs):  # noqa: E501
        """BinaryPlaintextMessageContent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, value_hex, type, *args, **kwargs):  # noqa: E501
        """BinaryPlaintextMessageContent - a model defined in OpenAPI
