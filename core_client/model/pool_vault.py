...
class PoolVault(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vault, resource_address, *args, **kwargs):  # noqa: E501
        """PoolVault - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, vault, resource_address, *args, **kwargs):  # noqa: E501
        """PoolVault - a model defined in OpenAPI
