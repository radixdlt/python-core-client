...
class RequireProofRule(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, requirement, type, *args, **kwargs):  # noqa: E501
        """RequireProofRule - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, requirement, type, *args, **kwargs):  # noqa: E501
        """RequireProofRule - a model defined in OpenAPI
