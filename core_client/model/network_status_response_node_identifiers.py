...
class NetworkStatusResponseNodeIdentifiers(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_entity_identifier, validator_entity_identifier, public_key, p2p_node, *args, **kwargs):  # noqa: E501
        """NetworkStatusResponseNodeIdentifiers - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_entity_identifier, validator_entity_identifier, public_key, p2p_node, *args, **kwargs):  # noqa: E501
        """NetworkStatusResponseNodeIdentifiers - a model defined in OpenAPI
