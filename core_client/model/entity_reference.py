...
class EntityReference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity_type, is_global, entity_address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity_type, is_global, entity_address, *args, **kwargs):  # noqa: E501
        """EntityReference - a model defined in OpenAPI
