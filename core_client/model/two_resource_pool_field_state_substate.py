...
class TwoResourcePoolFieldStateSubstate(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': (TwoResourcePoolFieldStateValue,),  # noqa: E501
    ...
    def _from_openapi_data(cls, value, substate_type, is_locked, *args, **kwargs):  # noqa: E501
        """TwoResourcePoolFieldStateSubstate - a model defined in OpenAPI
