...
class NotEnoughResourcesError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, available, attempted_to_take, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, available, attempted_to_take, *args, **kwargs):  # noqa: E501
        """NotEnoughResourcesError - a model defined in OpenAPI
