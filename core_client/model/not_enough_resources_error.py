...
class NotEnoughResourcesError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fee, available, attempted_to_take, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, fee, available, attempted_to_take, type, *args, **kwargs):  # noqa: E501
        """NotEnoughResourcesError - a model defined in OpenAPI
