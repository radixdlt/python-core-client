...
class StaticBlueprintPayloadDef(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'type_id': (ScopedTypeId,),  # noqa: E501
            'type': (BlueprintPayloadDefType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'Generic': GenericBlueprintPayloadDef,
            'Static': StaticBlueprintPayloadDef,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type_id, type, *args, **kwargs):  # noqa: E501
        """StaticBlueprintPayloadDef - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type_id, type, *args, **kwargs):  # noqa: E501
        """StaticBlueprintPayloadDef - a model defined in OpenAPI
