...
class EncryptedMessageCurveDecryptorSet(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'dh_ephemeral_public_key': (PublicKey,),  # noqa: E501
            'decryptors': ([EncryptedMessageDecryptor],),  # noqa: E501
        }
    ...
    attribute_map = {
        'dh_ephemeral_public_key': 'dh_ephemeral_public_key',  # noqa: E501
        'decryptors': 'decryptors',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dh_ephemeral_public_key, decryptors, *args, **kwargs):  # noqa: E501
        """EncryptedMessageCurveDecryptorSet - a model defined in OpenAPI

        Args:
            dh_ephemeral_public_key (PublicKey):
            decryptors ([EncryptedMessageDecryptor]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, dh_ephemeral_public_key, decryptors, *args, **kwargs):  # noqa: E501
        """EncryptedMessageCurveDecryptorSet - a model defined in OpenAPI
