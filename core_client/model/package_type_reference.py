...
class PackageTypeReference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, full_type_id, *args, **kwargs):  # noqa: E501
        """PackageTypeReference - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, full_type_id, *args, **kwargs):  # noqa: E501
        """PackageTypeReference - a model defined in OpenAPI
