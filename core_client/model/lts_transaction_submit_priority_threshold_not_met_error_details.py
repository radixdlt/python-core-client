...
class LtsTransactionSubmitPriorityThresholdNotMetErrorDetails(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'IntentAlreadyCommitted': LtsTransactionSubmitIntentAlreadyCommitted,
    ...
    def _from_openapi_data(cls, tip_percentage, type, *args, **kwargs):  # noqa: E501
        """LtsTransactionSubmitPriorityThresholdNotMetErrorDetails - a model defined in OpenAPI
