...
class LtsEntityNonFungibleBalanceChanges(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity_address, resource_address, added, removed, *args, **kwargs):  # noqa: E501
        """LtsEntityNonFungibleBalanceChanges - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity_address, resource_address, added, removed, *args, **kwargs):  # noqa: E501
        """LtsEntityNonFungibleBalanceChanges - a model defined in OpenAPI
