...
class ObjectSubstateTypeReference(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'ObjectInstanceTypeReference': ObjectInstanceTypeReference,
            'Package': PackageObjectSubstateTypeReference,
            'PackageObjectSubstateTypeReference': PackageObjectSubstateTypeReference,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """ObjectSubstateTypeReference - a model defined in OpenAPI
