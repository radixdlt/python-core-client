...
def lazy_import():
    ...
    globals()['RoleProtectedMethodAccessibilityAllOf'] = RoleProtectedMethodAccessibilityAllOf


class RoleProtectedMethodAccessibility(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'allowed_roles': ([str],),  # noqa: E501
            'type': (MethodAccessibilityType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'OuterObjectOnly': OuterObjectOnlyMethodAccessibility,
            'OwnPackageOnly': OwnPackageOnlyMethodAccessibility,
            'Public': PublicMethodAccessibility,
            'RoleProtected': RoleProtectedMethodAccessibility,
        }
        if not val:
            return None
        return {'type': val}
    ...
    attribute_map = {
        'allowed_roles': 'allowed_roles',  # noqa: E501
        'type': 'type',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, allowed_roles, type, *args, **kwargs):  # noqa: E501
        """RoleProtectedMethodAccessibility - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, allowed_roles, type, *args, **kwargs):  # noqa: E501
        """RoleProtectedMethodAccessibility - a model defined in OpenAPI
