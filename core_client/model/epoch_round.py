...
class EpochRound(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, epoch, round, *args, **kwargs):  # noqa: E501
        """EpochRound - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, epoch, round, *args, **kwargs):  # noqa: E501
        """EpochRound - a model defined in OpenAPI
