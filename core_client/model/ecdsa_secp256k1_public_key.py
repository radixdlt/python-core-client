...
class EcdsaSecp256k1PublicKey(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key_hex, key_type, *args, **kwargs):  # noqa: E501
        """EcdsaSecp256k1PublicKey - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key_hex, key_type, *args, **kwargs):  # noqa: E501
        """EcdsaSecp256k1PublicKey - a model defined in OpenAPI
