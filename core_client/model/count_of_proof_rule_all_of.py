...
class CountOfProofRuleAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, count, list, *args, **kwargs):  # noqa: E501
        """CountOfProofRuleAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, count, list, *args, **kwargs):  # noqa: E501
        """CountOfProofRuleAllOf - a model defined in OpenAPI
