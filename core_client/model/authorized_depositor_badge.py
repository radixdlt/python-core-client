...
class AuthorizedDepositorBadge(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'NonFungibleAuthorizedDepositorBadge': NonFungibleAuthorizedDepositorBadge,
            'Resource': ResourceAuthorizedDepositorBadge,
            'ResourceAuthorizedDepositorBadge': ResourceAuthorizedDepositorBadge,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """AuthorizedDepositorBadge - a model defined in OpenAPI
