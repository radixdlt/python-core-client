...
class PaymentFromVault(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vault_entity, xrd_amount, *args, **kwargs):  # noqa: E501
        """PaymentFromVault - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, vault_entity, xrd_amount, *args, **kwargs):  # noqa: E501
        """PaymentFromVault - a model defined in OpenAPI
