...
class TypeInfoDetails(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'KeyValueStoreTypeInfoDetails': KeyValueStoreTypeInfoDetails,
            'Object': ObjectTypeInfoDetails,
            'ObjectTypeInfoDetails': ObjectTypeInfoDetails,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """TypeInfoDetails - a model defined in OpenAPI
