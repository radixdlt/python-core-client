...
class RoyaltyModuleFieldStateValue(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, is_enabled, vault_entity, *args, **kwargs):  # noqa: E501
        """RoyaltyModuleFieldStateValue - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_enabled, vault_entity, *args, **kwargs):  # noqa: E501
        """RoyaltyModuleFieldStateValue - a model defined in OpenAPI
