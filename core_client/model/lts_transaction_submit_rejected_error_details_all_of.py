...
class LtsTransactionSubmitRejectedErrorDetailsAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, error_message, is_fresh, is_payload_rejection_permanent, is_intent_rejection_permanent, is_rejected_because_intent_already_committed, *args, **kwargs):  # noqa: E501
        """LtsTransactionSubmitRejectedErrorDetailsAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, error_message, is_fresh, is_payload_rejection_permanent, is_intent_rejection_permanent, is_rejected_because_intent_already_committed, *args, **kwargs):  # noqa: E501
        """LtsTransactionSubmitRejectedErrorDetailsAllOf - a model defined in OpenAPI
