...
class NonFungiblePresentedBadge(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (PresentedBadgeType,),  # noqa: E501
    ...
    def discriminator():
        lazy_import()
        val = {
            'NonFungible': NonFungiblePresentedBadge,
            'Resource': ResourcePresentedBadge,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, local_id, type, resource_address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, local_id, type, resource_address, *args, **kwargs):  # noqa: E501
        """NonFungiblePresentedBadge - a model defined in OpenAPI
