...
class ResourceDepositOperationNotSupportedByEntityError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity_identifier, resource_deposit_not_supported, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity_identifier, resource_deposit_not_supported, type, *args, **kwargs):  # noqa: E501
        """ResourceDepositOperationNotSupportedByEntityError - a model defined in OpenAPI
