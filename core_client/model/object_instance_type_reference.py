...
class ObjectInstanceTypeReference(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (ObjectSubstateTypeReferenceType,),  # noqa: E501
        }
    ...
    def discriminator():
        ...
        val = {
            ...
            'Package': PackageObjectSubstateTypeReference,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resolved_full_type_id, generic_index, type, *args, **kwargs):  # noqa: E501
        """ObjectInstanceTypeReference - a model defined in OpenAPI
        ...
        self.resolved_full_type_id = resolved_full_type_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, resolved_full_type_id, generic_index, type, *args, **kwargs):  # noqa: E501
        """ObjectInstanceTypeReference - a model defined in OpenAPI
