...
class StateResourceManager(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'StateFungibleResourceManager': StateFungibleResourceManager,
            'StateNonFungibleResourceManager': StateNonFungibleResourceManager,
        }
        if not val:
            return None
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_type, *args, **kwargs):  # noqa: E501
        """StateResourceManager - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_type, *args, **kwargs):  # noqa: E501
        """StateResourceManager - a model defined in OpenAPI
