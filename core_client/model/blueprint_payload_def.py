...
class BlueprintPayloadDef(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'GenericBlueprintPayloadDef': GenericBlueprintPayloadDef,
            'Static': StaticBlueprintPayloadDef,
            'StaticBlueprintPayloadDef': StaticBlueprintPayloadDef,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """BlueprintPayloadDef - a model defined in OpenAPI
