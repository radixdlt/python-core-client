...
class LtsTransactionStatusRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network, intent_hash, *args, **kwargs):  # noqa: E501
        """LtsTransactionStatusRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network, intent_hash, *args, **kwargs):  # noqa: E501
        """LtsTransactionStatusRequest - a model defined in OpenAPI
