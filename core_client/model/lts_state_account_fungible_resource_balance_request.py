...
class LtsStateAccountFungibleResourceBalanceRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network, account_address, resource_address, *args, **kwargs):  # noqa: E501
        """LtsStateAccountFungibleResourceBalanceRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network, account_address, resource_address, *args, **kwargs):  # noqa: E501
        """LtsStateAccountFungibleResourceBalanceRequest - a model defined in OpenAPI
