...
class LedgerTransaction(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'GenesisLedgerTransaction': GenesisLedgerTransaction,
            'RoundUpdate': RoundUpdateLedgerTransaction,
            'RoundUpdateLedgerTransaction': RoundUpdateLedgerTransaction,
            'User': UserLedgerTransaction,
            'UserLedgerTransaction': UserLedgerTransaction,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """LedgerTransaction - a model defined in OpenAPI
