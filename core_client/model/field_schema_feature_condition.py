...
class FieldSchemaFeatureCondition(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'type': (FieldSchemaFeatureConditionType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'Always': FieldSchemaFeatureConditionAlways,
            'FieldSchemaFeatureConditionAlways': FieldSchemaFeatureConditionAlways,
            'FieldSchemaFeatureConditionIfOuterObjectFeature': FieldSchemaFeatureConditionIfOuterObjectFeature,
            'FieldSchemaFeatureConditionIfOwnFeature': FieldSchemaFeatureConditionIfOwnFeature,
            'IfOuterObjectFeature': FieldSchemaFeatureConditionIfOuterObjectFeature,
            'IfOwnFeature': FieldSchemaFeatureConditionIfOwnFeature,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """FieldSchemaFeatureCondition - a model defined in OpenAPI
