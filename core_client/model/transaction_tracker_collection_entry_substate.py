...
def lazy_import():
    ...
    globals()['TransactionTrackerCollectionEntrySubstateAllOf'] = TransactionTrackerCollectionEntrySubstateAllOf
...
class TransactionTrackerCollectionEntrySubstate(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'key': (TransactionIdKey,),  # noqa: E501
            'value': (TransactionTrackerCollectionEntryValue,),  # noqa: E501
    ...
    def _from_openapi_data(cls, key, value, substate_type, is_locked, *args, **kwargs):  # noqa: E501
        """TransactionTrackerCollectionEntrySubstate - a model defined in OpenAPI
