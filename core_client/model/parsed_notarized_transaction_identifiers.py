...
class ParsedNotarizedTransactionIdentifiers(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, intent_hash, signed_intent_hash, payload_hash, ledger_hash, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, intent_hash, signed_intent_hash, payload_hash, ledger_hash, *args, **kwargs):  # noqa: E501
        """ParsedNotarizedTransactionIdentifiers - a model defined in OpenAPI
