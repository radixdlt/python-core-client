...
class RequireProofRuleAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, requirement, *args, **kwargs):  # noqa: E501
        """RequireProofRuleAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, requirement, *args, **kwargs):  # noqa: E501
        """RequireProofRuleAllOf - a model defined in OpenAPI
