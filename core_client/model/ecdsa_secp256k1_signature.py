...
class EcdsaSecp256k1Signature(ModelNormal):
    ...
    attribute_map = {
        'signature_hex': 'signature_hex',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, signature_hex, key_type, *args, **kwargs):  # noqa: E501
        """EcdsaSecp256k1Signature - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, signature_hex, key_type, *args, **kwargs):  # noqa: E501
        """EcdsaSecp256k1Signature - a model defined in OpenAPI
