...
class ProofRule(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'AllOfProofRule': AllOfProofRule,
            'AmountOf': AmountOfProofRule,
            'AmountOfProofRule': AmountOfProofRule,
            'AnyOf': AnyOfProofRule,
            'AnyOfProofRule': AnyOfProofRule,
            'CountOf': CountOfProofRule,
            'CountOfProofRule': CountOfProofRule,
            'Require': RequireProofRule,
            'RequireProofRule': RequireProofRule,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """ProofRule - a model defined in OpenAPI
