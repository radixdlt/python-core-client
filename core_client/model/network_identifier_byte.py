...
class NetworkIdentifierByte(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NetworkIdentifierByte - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): The logical id of the network.  # noqa: E501

        Keyword Args:
            value (int): The logical id of the network.  # noqa: E501
