...
class StatePackageRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network, package_address, *args, **kwargs):  # noqa: E501
        """StatePackageRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network, package_address, *args, **kwargs):  # noqa: E501
        """StatePackageRequest - a model defined in OpenAPI
