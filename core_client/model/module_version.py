...
class ModuleVersion(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'module': (AttachedModuleId,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, module, version, *args, **kwargs):  # noqa: E501
        """ModuleVersion - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, module, version, *args, **kwargs):  # noqa: E501
        """ModuleVersion - a model defined in OpenAPI
