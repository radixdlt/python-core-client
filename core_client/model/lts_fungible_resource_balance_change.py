...
class LtsFungibleResourceBalanceChange(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_address, balance_change, *args, **kwargs):  # noqa: E501
        """LtsFungibleResourceBalanceChange - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_address, balance_change, *args, **kwargs):  # noqa: E501
        """LtsFungibleResourceBalanceChange - a model defined in OpenAPI
