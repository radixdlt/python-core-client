...
class AnyOfAccessRuleNode(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'access_rules': ([AccessRuleNode],),  # noqa: E501
            'type': (AccessRuleNodeType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'AllOf': AllOfAccessRuleNode,
            'AnyOf': AnyOfAccessRuleNode,
            'ProofRule': ProofAccessRuleNode,
        }
        if not val:
            return None
        return {'type': val}
    ...
    attribute_map = {
        'access_rules': 'access_rules',  # noqa: E501
        'type': 'type',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access_rules, type, *args, **kwargs):  # noqa: E501
        """AnyOfAccessRuleNode - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_rules, type, *args, **kwargs):  # noqa: E501
        """AnyOfAccessRuleNode - a model defined in OpenAPI
