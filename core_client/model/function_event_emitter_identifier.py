...
class FunctionEventEmitterIdentifier(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'object_module_id': (ObjectModuleId,),  # noqa: E501
            'blueprint_name': (str,),  # noqa: E501
            'type': (EventEmitterIdentifierType,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'Function': FunctionEventEmitterIdentifier,
            'Method': MethodEventEmitterIdentifier,
        }
        if not val:
            return None
        return {'type': val}
    ...
    attribute_map = {
        ...
        'object_module_id': 'object_module_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity, object_module_id, blueprint_name, type, *args, **kwargs):  # noqa: E501
        """FunctionEventEmitterIdentifier - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity, object_module_id, blueprint_name, type, *args, **kwargs):  # noqa: E501
        """FunctionEventEmitterIdentifier - a model defined in OpenAPI
