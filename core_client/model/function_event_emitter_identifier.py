...
class FunctionEventEmitterIdentifier(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, package_address, blueprint_name, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, package_address, blueprint_name, type, *args, **kwargs):  # noqa: E501
        """FunctionEventEmitterIdentifier - a model defined in OpenAPI
