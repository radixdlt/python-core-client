...
def lazy_import():
    ...
    globals()['PackageSchemaEntrySubstateAllOf'] = PackageSchemaEntrySubstateAllOf
...
class PackageSchemaEntrySubstate(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'key': (SchemaKey,),  # noqa: E501
            'value': (PackageSchemaEntryValue,),  # noqa: E501
    ...
    def _from_openapi_data(cls, key, value, substate_type, is_locked, *args, **kwargs):  # noqa: E501
        """PackageSchemaEntrySubstate - a model defined in OpenAPI
