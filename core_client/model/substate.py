...
class Substate(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'AccessControllerFieldStateSubstate': AccessControllerFieldStateSubstate,
            'AccountAuthorizedDepositorEntry': AccountAuthorizedDepositorEntrySubstate,
            'AccountAuthorizedDepositorEntrySubstate': AccountAuthorizedDepositorEntrySubstate,
            'AccountFieldState': AccountFieldStateSubstate,
            'AccountFieldStateSubstate': AccountFieldStateSubstate,
            'AccountResourcePreferenceEntry': AccountResourcePreferenceEntrySubstate,
            'AccountResourcePreferenceEntrySubstate': AccountResourcePreferenceEntrySubstate,
            'AccountVaultEntry': AccountVaultEntrySubstate,
            'AccountVaultEntrySubstate': AccountVaultEntrySubstate,
            'ConsensusManagerFieldConfig': ConsensusManagerFieldConfigSubstate,
            'ConsensusManagerFieldConfigSubstate': ConsensusManagerFieldConfigSubstate,
            'ConsensusManagerFieldCurrentProposalStatistic': ConsensusManagerFieldCurrentProposalStatisticSubstate,
            'ConsensusManagerFieldCurrentProposalStatisticSubstate': ConsensusManagerFieldCurrentProposalStatisticSubstate,
            ...
            'ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate': ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate,
            'ConsensusManagerFieldCurrentTimeSubstate': ConsensusManagerFieldCurrentTimeSubstate,
            'ConsensusManagerFieldCurrentValidatorSet': ConsensusManagerFieldCurrentValidatorSetSubstate,
            'ConsensusManagerFieldCurrentValidatorSetSubstate': ConsensusManagerFieldCurrentValidatorSetSubstate,
            'ConsensusManagerFieldState': ConsensusManagerFieldStateSubstate,
            'ConsensusManagerFieldStateSubstate': ConsensusManagerFieldStateSubstate,
            'ConsensusManagerFieldValidatorRewards': ConsensusManagerFieldValidatorRewardsSubstate,
            'ConsensusManagerFieldValidatorRewardsSubstate': ConsensusManagerFieldValidatorRewardsSubstate,
            'ConsensusManagerRegisteredValidatorsByStakeIndexEntry': ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate,
            'ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate': ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate,
            'FungibleResourceManagerFieldDivisibility': FungibleResourceManagerFieldDivisibilitySubstate,
            'FungibleResourceManagerFieldDivisibilitySubstate': FungibleResourceManagerFieldDivisibilitySubstate,
            'FungibleResourceManagerFieldTotalSupply': FungibleResourceManagerFieldTotalSupplySubstate,
            'FungibleResourceManagerFieldTotalSupplySubstate': FungibleResourceManagerFieldTotalSupplySubstate,
            'FungibleVaultFieldBalance': FungibleVaultFieldBalanceSubstate,
            'FungibleVaultFieldBalanceSubstate': FungibleVaultFieldBalanceSubstate,
            'FungibleVaultFieldFrozenStatus': FungibleVaultFieldFrozenStatusSubstate,
            'FungibleVaultFieldFrozenStatusSubstate': FungibleVaultFieldFrozenStatusSubstate,
            'GenericKeyValueStoreEntry': GenericKeyValueStoreEntrySubstate,
            'GenericKeyValueStoreEntrySubstate': GenericKeyValueStoreEntrySubstate,
            'GenericScryptoComponentFieldState': GenericScryptoComponentFieldStateSubstate,
            'GenericScryptoComponentFieldStateSubstate': GenericScryptoComponentFieldStateSubstate,
            'MetadataModuleEntry': MetadataModuleEntrySubstate,
            'MetadataModuleEntrySubstate': MetadataModuleEntrySubstate,
            'MultiResourcePoolFieldState': MultiResourcePoolFieldStateSubstate,
            'MultiResourcePoolFieldStateSubstate': MultiResourcePoolFieldStateSubstate,
            'NonFungibleResourceManagerDataEntry': NonFungibleResourceManagerDataEntrySubstate,
            'NonFungibleResourceManagerDataEntrySubstate': NonFungibleResourceManagerDataEntrySubstate,
            'NonFungibleResourceManagerFieldIdType': NonFungibleResourceManagerFieldIdTypeSubstate,
            'NonFungibleResourceManagerFieldIdTypeSubstate': NonFungibleResourceManagerFieldIdTypeSubstate,
            'NonFungibleResourceManagerFieldMutableFields': NonFungibleResourceManagerFieldMutableFieldsSubstate,
            'NonFungibleResourceManagerFieldMutableFieldsSubstate': NonFungibleResourceManagerFieldMutableFieldsSubstate,
            'NonFungibleResourceManagerFieldTotalSupply': NonFungibleResourceManagerFieldTotalSupplySubstate,
            'NonFungibleResourceManagerFieldTotalSupplySubstate': NonFungibleResourceManagerFieldTotalSupplySubstate,
            'NonFungibleVaultContentsIndexEntry': NonFungibleVaultContentsIndexEntrySubstate,
            'NonFungibleVaultContentsIndexEntrySubstate': NonFungibleVaultContentsIndexEntrySubstate,
            'NonFungibleVaultFieldBalance': NonFungibleVaultFieldBalanceSubstate,
            'NonFungibleVaultFieldBalanceSubstate': NonFungibleVaultFieldBalanceSubstate,
            'NonFungibleVaultFieldFrozenStatus': NonFungibleVaultFieldFrozenStatusSubstate,
            'NonFungibleVaultFieldFrozenStatusSubstate': NonFungibleVaultFieldFrozenStatusSubstate,
            'OneResourcePoolFieldState': OneResourcePoolFieldStateSubstate,
            'OneResourcePoolFieldStateSubstate': OneResourcePoolFieldStateSubstate,
            'PackageBlueprintAuthTemplateEntry': PackageBlueprintAuthTemplateEntrySubstate,
            'PackageBlueprintAuthTemplateEntrySubstate': PackageBlueprintAuthTemplateEntrySubstate,
            'PackageBlueprintDefinitionEntry': PackageBlueprintDefinitionEntrySubstate,
            'PackageBlueprintDefinitionEntrySubstate': PackageBlueprintDefinitionEntrySubstate,
            'PackageBlueprintDependenciesEntry': PackageBlueprintDependenciesEntrySubstate,
            'PackageBlueprintDependenciesEntrySubstate': PackageBlueprintDependenciesEntrySubstate,
            'PackageBlueprintRoyaltyEntry': PackageBlueprintRoyaltyEntrySubstate,
            'PackageBlueprintRoyaltyEntrySubstate': PackageBlueprintRoyaltyEntrySubstate,
            'PackageCodeInstrumentedCodeEntry': PackageCodeInstrumentedCodeEntrySubstate,
            'PackageCodeInstrumentedCodeEntrySubstate': PackageCodeInstrumentedCodeEntrySubstate,
            'PackageCodeOriginalCodeEntry': PackageCodeOriginalCodeEntrySubstate,
            'PackageCodeOriginalCodeEntrySubstate': PackageCodeOriginalCodeEntrySubstate,
            'PackageCodeVmTypeEntry': PackageCodeVmTypeEntrySubstate,
            'PackageCodeVmTypeEntrySubstate': PackageCodeVmTypeEntrySubstate,
            'PackageFieldRoyaltyAccumulator': PackageFieldRoyaltyAccumulatorSubstate,
            'PackageFieldRoyaltyAccumulatorSubstate': PackageFieldRoyaltyAccumulatorSubstate,
            'RoleAssignmentModuleFieldOwnerRole': RoleAssignmentModuleFieldOwnerRoleSubstate,
            'RoleAssignmentModuleFieldOwnerRoleSubstate': RoleAssignmentModuleFieldOwnerRoleSubstate,
            'RoleAssignmentModuleRuleEntry': RoleAssignmentModuleRuleEntrySubstate,
            'RoleAssignmentModuleRuleEntrySubstate': RoleAssignmentModuleRuleEntrySubstate,
            'RoyaltyModuleFieldState': RoyaltyModuleFieldStateSubstate,
            'RoyaltyModuleFieldStateSubstate': RoyaltyModuleFieldStateSubstate,
            'RoyaltyModuleMethodRoyaltyEntry': RoyaltyModuleMethodRoyaltyEntrySubstate,
            'RoyaltyModuleMethodRoyaltyEntrySubstate': RoyaltyModuleMethodRoyaltyEntrySubstate,
            'SchemaEntry': SchemaEntrySubstate,
            'SchemaEntrySubstate': SchemaEntrySubstate,
            'TransactionTrackerCollectionEntry': TransactionTrackerCollectionEntrySubstate,
            'TransactionTrackerCollectionEntrySubstate': TransactionTrackerCollectionEntrySubstate,
            'TransactionTrackerFieldState': TransactionTrackerFieldStateSubstate,
            'TransactionTrackerFieldStateSubstate': TransactionTrackerFieldStateSubstate,
            'TwoResourcePoolFieldState': TwoResourcePoolFieldStateSubstate,
            'TwoResourcePoolFieldStateSubstate': TwoResourcePoolFieldStateSubstate,
            'TypeInfoModuleFieldTypeInfo': TypeInfoModuleFieldTypeInfoSubstate,
            'TypeInfoModuleFieldTypeInfoSubstate': TypeInfoModuleFieldTypeInfoSubstate,
            'ValidatorFieldProtocolUpdateReadinessSignal': ValidatorFieldProtocolUpdateReadinessSignalSubstate,
            'ValidatorFieldProtocolUpdateReadinessSignalSubstate': ValidatorFieldProtocolUpdateReadinessSignalSubstate,
            'ValidatorFieldState': ValidatorFieldStateSubstate,
            'ValidatorFieldStateSubstate': ValidatorFieldStateSubstate,
        }
        if not val:
            return None
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, substate_type, is_locked, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, substate_type, is_locked, *args, **kwargs):  # noqa: E501
        """Substate - a model defined in OpenAPI
