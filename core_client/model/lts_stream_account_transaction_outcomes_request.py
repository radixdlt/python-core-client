...
class LtsStreamAccountTransactionOutcomesRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network, account_address, from_state_version, limit, *args, **kwargs):  # noqa: E501
        """LtsStreamAccountTransactionOutcomesRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network, account_address, from_state_version, limit, *args, **kwargs):  # noqa: E501
        """LtsStreamAccountTransactionOutcomesRequest - a model defined in OpenAPI
