...
class SubstateDependencyNotFoundError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, substate_identifier_not_found, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, substate_identifier_not_found, type, *args, **kwargs):  # noqa: E501
        """SubstateDependencyNotFoundError - a model defined in OpenAPI
