...
class NotEnoughNativeTokensForFeesError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, available, fee_estimate, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, available, fee_estimate, type, *args, **kwargs):  # noqa: E501
        """NotEnoughNativeTokensForFeesError - a model defined in OpenAPI
