...
class LTSApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __lts_state_account_deposit_behaviour_post(
            self,
            lts_state_account_deposit_behaviour_request,
            **kwargs
        ):
            """Get Account Deposit Behaviour  # noqa: E501

            Returns deposit behaviour of a single account for multiple resource addresses  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.lts_state_account_deposit_behaviour_post(lts_state_account_deposit_behaviour_request, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['lts_state_account_deposit_behaviour_request'] = \
                lts_state_account_deposit_behaviour_request
            return self.call_with_http_info(**kwargs)

        self.lts_state_account_deposit_behaviour_post = _Endpoint(
            settings={
                'response_type': (LtsStateAccountDepositBehaviourResponse,),
                'auth': [],
                'endpoint_path': '/lts/state/account-deposit-behaviour',
                'operation_id': 'lts_state_account_deposit_behaviour_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'lts_state_account_deposit_behaviour_request': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__lts_state_account_deposit_behaviour_post
        )
