...
class NodeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __node_identifiers_post(
            self,
            node_identifiers_request,
            **kwargs
        ):
            """Get the node's identifiers  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.node_identifiers_post(node_identifiers_request, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['node_identifiers_request'] = \
                node_identifiers_request
            return self.call_with_http_info(**kwargs)

        self.node_identifiers_post = _Endpoint(
            settings={
                'response_type': (NodeIdentifiersResponse,),
                'auth': [],
                'endpoint_path': '/node/identifiers',
                'operation_id': 'node_identifiers_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__node_identifiers_post
        )

        def __node_sign_post(
            self,
            node_sign_request,
            **kwargs
        ):
            """Sign a transaction with the node's key  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.node_sign_post(node_sign_request, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['node_sign_request'] = \
                node_sign_request
            return self.call_with_http_info(**kwargs)

        self.node_sign_post = _Endpoint(
            settings={
                'response_type': (NodeSignResponse,),
                'auth': [],
                'endpoint_path': '/node/sign',
                'operation_id': 'node_sign_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
