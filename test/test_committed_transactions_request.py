...
from openapi_client.model.partial_state_identifier import PartialStateIdentifier
globals()['NetworkIdentifier'] = NetworkIdentifier
globals()['PartialStateIdentifier'] = PartialStateIdentifier
from openapi_client.model.committed_transactions_request import CommittedTransactionsRequest


class TestCommittedTransactionsRequest(unittest.TestCase):
    """CommittedTransactionsRequest unit test stubs"""
    ...
    def testCommittedTransactionsRequest(self):
        """Test CommittedTransactionsRequest"""
        # FIXME: construct object with mandatory attributes with example values
        # model = CommittedTransactionsRequest()  # noqa: E501
        pass
