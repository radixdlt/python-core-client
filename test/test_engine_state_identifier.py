...
class TestEngineStateIdentifier(unittest.TestCase):
    """EngineStateIdentifier unit test stubs"""
    ...
    def testEngineStateIdentifier(self):
        """Test EngineStateIdentifier"""
        # FIXME: construct object with mandatory attributes with example values
        # model = EngineStateIdentifier()  # noqa: E501
        pass
