...
class TestNodeSignRequest(unittest.TestCase):
    """NodeSignRequest unit test stubs"""
    ...
    def testNodeSignRequest(self):
        """Test NodeSignRequest"""
        # FIXME: construct object with mandatory attributes with example values
        # model = NodeSignRequest()  # noqa: E501
        pass
