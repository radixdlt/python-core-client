...
class TestUnclaimedRadixEngineAddress(unittest.TestCase):
    """UnclaimedRadixEngineAddress unit test stubs"""
    ...
    def testUnclaimedRadixEngineAddress(self):
        """Test UnclaimedRadixEngineAddress"""
        # FIXME: construct object with mandatory attributes with example values
        # model = UnclaimedRadixEngineAddress()  # noqa: E501
        pass
