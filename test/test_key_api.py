...
import core_client
from core_client.api.key_api import KeyApi  # noqa: E501
...
class TestKeyApi(unittest.TestCase):
    ...
    def test_key_list_post(self):
        """Test case for key_list_post

        Get the node's supported public keys  # noqa: E501
        """
        pass

    def test_key_sign_post(self):
        """Test case for key_sign_post
