...
from openapi_client.model.network_status_response_node_identifiers import NetworkStatusResponseNodeIdentifiers


class TestNetworkStatusResponseNodeIdentifiers(unittest.TestCase):
    """NetworkStatusResponseNodeIdentifiers unit test stubs"""
    ...
    def testNetworkStatusResponseNodeIdentifiers(self):
        """Test NetworkStatusResponseNodeIdentifiers"""
        # FIXME: construct object with mandatory attributes with example values
        # model = NetworkStatusResponseNodeIdentifiers()  # noqa: E501
        pass
