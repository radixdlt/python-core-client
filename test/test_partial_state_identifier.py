...
class TestPartialStateIdentifier(unittest.TestCase):
    """PartialStateIdentifier unit test stubs"""
    ...
    def testPartialStateIdentifier(self):
        """Test PartialStateIdentifier"""
        # FIXME: construct object with mandatory attributes with example values
        # model = PartialStateIdentifier()  # noqa: E501
        pass
