...
class TestEngineIdentifier(unittest.TestCase):
    """EngineIdentifier unit test stubs"""
    ...
    def testEngineIdentifier(self):
        """Test EngineIdentifier"""
        # FIXME: construct object with mandatory attributes with example values
        # model = EngineIdentifier()  # noqa: E501
        pass
