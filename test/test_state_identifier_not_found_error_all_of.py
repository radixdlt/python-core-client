...
from openapi_client.model.state_identifier_not_found_error_all_of import StateIdentifierNotFoundErrorAllOf


class TestStateIdentifierNotFoundErrorAllOf(unittest.TestCase):
    """StateIdentifierNotFoundErrorAllOf unit test stubs"""
    ...
    def testStateIdentifierNotFoundErrorAllOf(self):
        """Test StateIdentifierNotFoundErrorAllOf"""
        # FIXME: construct object with mandatory attributes with example values
        # model = StateIdentifierNotFoundErrorAllOf()  # noqa: E501
        pass
